          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 2xl:grid-cols-8 gap-3">
            {getCurrentLinks().map(link => (
              <a
                ...
                className="group flex items-center p-2.5 bg-white rounded-lg border hover:shadow-md transition-all duration-200 relative hover:border-blue-200"
              >
                <FavoriteButton
                  id={link.id}
                ...
                <div className="mr-2.5 w-7 h-7 flex-shrink-0 flex items-center justify-center">
                  <img
