  ...
  return (
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="px-8">
          <div className="flex h-14">
            ...
            >
              ...
              <span className="ml-2 text-lg font-medium">返回首页</span>
            </Link>
          </div>
        </div>
      </nav>
      ...
      <div className="flex">
        {/* 侧边栏 */}
        <div 
          className="admin-sidebar bg-white shadow-sm h-[calc(100vh-3.5rem)] flex-shrink-0"
            ...
            <div className="space-y-2">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  href={item.href}
                  className="group flex items-center px-4 py-3 text-base font-medium rounded-md text-gray-600 hover:text-gray-900 hover:bg-gray-50 whitespace-nowrap"
                >
                  <item.icon
