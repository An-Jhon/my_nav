                        ...
                        {(provided, snapshot) => (
                          <div
                            ...
                            style={{
                              ...
                              width: 'calc(16.666% - 12px)', // 对应于 2xl:grid-cols-8
                              '@media (max-width: 1536px)': {
                                width: 'calc(20% - 12px)', // xl:grid-cols-6
                              },
                              '@media (max-width: 1280px)': {
                                width: 'calc(25% - 12px)', // lg:grid-cols-4
                              },
                              '@media (max-width: 1024px)': {
                                width: 'calc(33.333% - 12px)', // sm:grid-cols-3
                              },
                              '@media (max-width: 640px)': {
                                width: 'calc(50% - 12px)', // grid-cols-2
                              },
                            }}
                            className={`
                            ...
                            `}
                          >
                            <div className="bg-white rounded-lg border hover:shadow-md transition-all duration-200 relative hover:border-blue-200">
