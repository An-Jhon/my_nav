  ...
  return (
    <div className="flex min-h-screen">
      <aside 
        ...
        className="flex-shrink-0 bg-white border-r border-gray-200 transition-all duration-200 ease-in-out"
      >
        <nav className="sticky top-0 p-3">
          <h2 className="text-sm font-medium text-gray-600 mb-3 px-2">分类导航</h2>
