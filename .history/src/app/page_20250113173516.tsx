          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 p-4">
            {currentLinks.map(link => (
              <a
                ...
                className="group block bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 relative h-[120px]"
              >
                <FavoriteButton
                  id={link.id}
                ...
                <div className="flex items-start space-x-3">
                  <div className="w-8 h-8 flex-shrink-0 flex items-center justify-center">
                    <img
                      ...
                      width={32}
                      height={32}
                      className="rounded-lg group-hover:scale-110 transition-transform duration-200 bg-gray-50"
                      onError={(e) => {
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-xs text-gray-500 mt-1.5 line-clamp-2 group-hover:text-gray-600">
