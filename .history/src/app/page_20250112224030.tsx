          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2">
            {getCurrentLinks().map(link => (
              <a
                ...
                className="group flex items-start p-2 bg-white rounded-lg border hover:shadow-md transition-all duration-200 relative hover:border-blue-200"
              >
                <FavoriteButton
                  id={link.id}
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-xs text-gray-500 line-clamp-1 mt-0.5 group-hover:text-gray-600">
                    {link.description}
                  </p>
                </div>
              </a>
